...
(ert-deftest filetags-remove-can-remove-date-test
    ()
  (let ((old-path "/home/max/2018-06-01_test.txt"))
    (should (equal (filetags-remove-date old-path) "/home/max/test.txt"))))


(ert-deftest filetags-remove-leaves-other-filenames-unaffected
    ()
  (let ((old-path "/home/max/test.txt"))
    (should (equal (filetags-remove-date old-path) "/home/max/test.txt"))))


(ert-deftest filetags-remove-can-remove-datetime
    ()
